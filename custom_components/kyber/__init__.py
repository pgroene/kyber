...
async def async_setup_entry(hass: HomeAssistant, entry: KyberConfigEntry) -> bool:
    ...
    try:
        await async_register_panel(
            ...
            module_url="/local/kyber/kyber-panel.js?v1=161",
        )
