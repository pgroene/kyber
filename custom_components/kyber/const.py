...
CONF_MCP_EXPOSED_LABELS = "mcp_exposed_labels"     # list[str] — only expose entities with these labels
CONF_MCP_EXPOSED_AREAS = "mcp_exposed_areas"       # list[str] — only expose entities in these areas
CONF_MCP_HIDDEN_ENTITIES = "mcp_hidden_entities"   # list[str] — entity IDs to always hide
CONF_MCP_TOOL_MODE = "mcp_tool_mode"               # "kyber_only" | "dynamic" | "hybrid"
CONF_MCP_SESSION_TIMEOUT = "mcp_session_timeout"   # int minutes, 0 = no sessions
...
DEFAULT_MCP_TOOL_MODE = "kyber_only"
DEFAULT_MCP_SESSION_TIMEOUT = 30  # minutes
