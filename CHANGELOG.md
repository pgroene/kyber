...
- **[High]** Path traversal in self-update zip extraction — checks for `..` path components and absolute paths _before_ `mkdir()`, preventing writes outside `custom_components/kyber/`
...
### Fixed
- Copy button broken on HTTP (non-HTTPS) setups — `navigator.clipboard.writeText` requires HTTPS; added `execCommand('copy')` fallback so copy works on plain HTTP local installs

---

## [0.5.3] — 2026-05-21 21:59 +0200

### Fixed
- `CLOUD_PROVIDER_ANTHROPIC` `NameError` in the `www/` copy of `http_api.py` — missing import caused a 500 error when Anthropic was selected

---

## [0.5.2] — 2026-05-21 21:44 +0200
...
## [0.4.6] — 2026-05-21 20:41 +0200

### Fixed
- Busy flag and log handler not cleared on all AI error paths — the panel remained permanently locked after a timeout or unhandled exception (closes #164)

---

## [0.4.5] — 2026-05-21 18:25 +0200

_Tag alias for v0.4.4 — same commit._

---

## [0.4.4] — 2026-05-21 18:25 +0200
...
## [0.4.1] — 2026-05-21 17:06 +0200

### Fixed
- Config entry `options` not merged into the active config dict at setup — cloud provider settings were silently ignored after a Home Assistant restart

---

## [0.4.0] — 2026-05-21 16:41 +0200
...
## [0.3.3] — 2026-05-21 11:28 +0200

### Added
- Model name included in `[AI→]` / `[AI←]` debug log lines for easier multi-model diagnostics
...
## [0.3.2] — 2026-05-21 11:13 +0200

### Fixed
- Kyber logger not set to `DEBUG` level when debug mode is enabled — detailed request/response logs were being silently discarded at the default `WARNING` level

---

## [0.3.1] — 2026-05-21 10:08 +0200
...
## [0.2.21] — 2026-05-20 23:01 +0200

### Fixed
- Main Kyber panel not removed on integration unload/remove — stale sidebar entry persisted across HA restarts

---

## [0.2.20] — 2026-05-20 22:50 +0200
...
## [0.2.19] — 2026-05-20 22:34 +0200

### Added
- `async_step_reconfigure` support in the config flow — allows editing the Ollama connection without removing and re-adding the integration

---

## [0.2.18] — 2026-05-20 21:58 +0200
...
## [0.2.15] — 2026-05-20 20:59 +0200

### Fixed
- Stop 401 poll storm when the HA session expires — the progress-poller now backs off instead of flooding requests
- Debug panel JSON parse error guarded against malformed responses

---

## [0.2.14] — 2026-05-20 20:16 +0200
...
## [0.2.8] — 2026-05-20 14:09 +0200

### Performance
- System prompt compressed 31% (−2 007 tokens) by removing redundant tool descriptions and merging static instruction blocks

---

## [0.2.7] — 2026-05-20 14:01 +0200
...
## [0.2.1] — 2026-05-20 11:11 +0200

### Fixed
- Domain-intent boost in memory retrieval was not applied — relevant domain entries were ranked too low
- Media player search hint missing from entity vocabulary

---

## [0.2.0] — 2026-05-20 08:08 +0200

### Added
- `/update force` — self-update directly from the latest GitHub release, bypassing HACS
...
## [0.1.19] — 2026-05-16 18:20 +0200

### Added
- State filter on `list_entities` tool — filter by state value (e.g. `on`, `off`, `unavailable`)
- New `list_entities_without_area` tool for area-assignment workflows
- Tool name alias resolution — the AI can use alternate names for tools without triggering an error

---

## [0.1.18] — 2026-05-16 18:05 +0200

### Fixed
- `T00L_CALL` zero/O regex: the AI sometimes writes `T00L_CALL` with a zero instead of the letter O — both are now handled
- Intent classifier over-triggering on borderline messages reduced via stricter matching

---

## [0.1.17] — 2026-05-16 17:51 +0200
...
## [0.1.5] — 2026-05-16 16:16 +0200

### Added
- Smart context: area-based home-state snapshot — only entities relevant to the user's request (by area) are included in the AI prompt; a context badge shows which areas were selected

---

## [0.1.4] — 2026-05-16 15:44 +0200

### Fixed
- Removed `/no_think` system-prompt suffix — it was producing raw token-ID output on llama3

---

## [0.1.3] — 2026-05-16 15:24 +0200
...
## [0.1.0] — 2026-05-16 10:51 +0200

### Added
- **Initial release** — Kyber submitted to HACS custom repositories
...
- AI Entity Narrator — background batch narration of all entities with alias generation
